...
sudo apt-get install -y php7.1-common php7.1-mysql php7.1-fpm php7.1-curl php7.1-gd php7.1-bz2 php7.1-mbstring php7.1-xml php7.1-sqlite php7.1-zip php7.1-pgsql
